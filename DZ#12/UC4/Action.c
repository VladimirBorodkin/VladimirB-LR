Action()
{
	...
	lr_start_transaction("Viewing_ticket");
...
/*Correlation comment - Do not change!  Original value='138964.267152693HVtHQHtptQVzzzzHtciiHpitzQf' Name ='userSession' Type ='ResponseBased'*/
...
/*Correlation comment - Do not change!  Original value='itinerary' Name ='page' Type ='ResponseBased'*/
	...
	lr_end_transaction("Viewing_ticket", LR_AUTO);
