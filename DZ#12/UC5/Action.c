...
/*Correlation comment - Do not change!  Original value='138964.285378696HVtHQHfptcQVzzzHtciiHpifcfHf' Name ='userSession' Type ='ResponseBased'*/
...
/*Correlation comment - Do not change!  Original value='0-7-JB' Name ='flightID' Type ='ResponseBased'*/
	web_reg_save_param_attrib(
		"ParamName=flightID",
		"TagName=input",
		"Extract=value",
